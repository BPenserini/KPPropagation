function [KP_distance, Modeled_KP_Locations, sum_of_misfit, C_optimal, p_optimal] = RunKPModel_051721(Obs_Distances, StreamSgmnts, A, Cmin, Cmax, pmin, pmax, age, output_filename)
